package memory.respond.nos.activity;
...
import memory.respond.nos.R;
import memory.respond.nos.adapter.MainAdapter;
import memory.respond.nos.data.Favorite_DBopenHelper;
import memory.respond.nos.data.Main_Data;
import memory.respond.nos.data.Pause_DBOpenHelper;
import memory.respond.nos.mediaplayer.ContinueMediaPlayer;
...
public class MainActivity extends Activity implements OnItemClickListener, OnClickListener, OnScrollListener, AdViewListener, CustomPopupListener, InterstitialAdListener{
	...
	AdMixerManager.getInstance().setAdapterDefaultAppCode(AdAdapter.ADAPTER_ADMIXER, "bf9hkk11");
	AdMixerManager.getInstance().setAdapterDefaultAppCode(AdAdapter.ADAPTER_ADMOB, "ca-app-pub-4637651494513698/3956884561");
	AdMixerManager.getInstance().setAdapterDefaultAppCode(AdAdapter.ADAPTER_ADMOB_FULL, "ca-app-pub-4637651494513698/5433617760");
	
//	  Custom Popup 시작
	CustomPopup.setCustomPopupListener(this);
	CustomPopup.startCustomPopup(this, "bf9hkk11");
	...
	public void addBannerView() {
    	AdInfo adInfo = new AdInfo("bf9hkk11");
			        	...
			        	if (eventType == XmlPullParser.START_DOCUMENT) {
			            	...
			            	if(sTag.equals("Content")){
			            		...
			            		if(searchKeyword != null && "".equals(searchKeyword.trim()) == false){
			        				...
			        				match2 = matcher2.match(main_data.title.toUpperCase());
			        				if(match1.success()){
			        					list.add(main_data);
